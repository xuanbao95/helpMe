...
export default function SpringModal({ handleClose, handleOpen, product, open }) {
  ...
  // const productSum = useSelector(state => state.reducerCart.product);
  // console.log(useSelector(state => state.reducerCart.product))
            ...
            <Grid container direction="row" justify="center" alignItems="center">
              ...
              <Grid item xs={6}>
                <div className={classes.Checkout}>
                  <button className={classes.CheckoutButton} onClick={() => history.push("/cart")}>View bag</button>
                </div>
